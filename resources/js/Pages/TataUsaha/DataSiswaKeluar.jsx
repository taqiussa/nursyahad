...
import getAllSiswaKeluar from '@/Functions/getAllSiswaKeluar'
...
const DataSiswaKeluar = ({ initTahun }) => {
    ...
    async function getDataSiswa() {
        const res = await getAllSiswaKeluar(data.tahun)
                            ...
                            filteredData
                                ...
                                .map((siswa, index) => (
                                    <tr key={index} className="bg-white border-b hover:bg-slate-300 odd:bg-slate-200">
                                        ...
                                        {/* <td className="py-2 px-2 font-medium text-slate-600">
                                            <LinkEdit href={route('tambah-siswa.edit', { nis: siswa.nis })} />
                                        </td> */}
                                    </tr>
                                ))}
                    </tbody>
...
DataSiswaKeluar.layout = page => <AppLayout children={page} />
export default DataSiswaKeluar